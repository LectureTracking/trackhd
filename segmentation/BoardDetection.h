...
public:
    ...
    void findRectangles(cv::Mat &frame, cv::Rect &cropArea, std::vector<BoardRect> &boardRects, std::vector<BoardRect> &boardColumnRects);
    ...
    void findBoards(std::vector<cv::Rect> &allRectangles, std::vector<cv::Rect> &possibleBoardColumns, std::vector<BoardRect> &boards);
    ...
    void findAreaToSegment(std::vector<BoardRect> &boardColumns, cv::Rect &finalCrop, std::vector<BoardRect> &Boards);
